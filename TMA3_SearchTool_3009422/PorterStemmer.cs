...
namespace PorterStemmingAlgorithm
{
    // Stemmer retrieved from http://tartarus.org/martin/PorterStemmer/csharp3.txt
    // Modified by Michael Gallichan
    ...
    public static class PorterStemmer
    {
        ...
        {
            // >>> start of edit by Michael Gallichan <<<
            if (word.EndsWith("'s")) // remove the last 2 chars from end of values ending with 's
            {
        ...
        private static bool IsConsonant(int index)
        {
        ...
        /* m() measures the number of consonant sequences between 0 and j. if c is
            ...
            presence,
                ...
                <c>vcvcvc<v> gives 3
                ....		*/
        private static int MeasureConsonantSequence()
        {
            var n = 0;
            var index = 0;
            while (true)
        ...
        private static bool VowelInStem()
        {
            int i;
        ...
        private static bool IsDoubleConsonant(int index)
        {
        ...
        /* cvc(i) is true <=> i-2,i-1,i has the form consonant - vowel - consonant
            ...
            restore an e at the end of a short word. e.g.
                ...
                snow, box, tray.		*/
        private static bool IsCVC(int index)
        {
        ...
        private static void SetEnd(string s)
        {
            var length = s.Length;
        ...
        private static void ReplaceEnd(string s)
        {
